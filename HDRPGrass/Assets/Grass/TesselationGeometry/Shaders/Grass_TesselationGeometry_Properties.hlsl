...
half4 _GrassLODSqrDistances;
half4 _GrassLODSegments;
half4 _GrassLODDensities;

half _FrustumCullingScreenSpaceMargin;
...
float4 _FieldTexture_ST;

sampler2D _BladeTexture;
float4 _BladeTexture_ST;

half4 _GrassBottomColour;
half4 _GrassTopColour;

float4 _AbsoluteNormal;
